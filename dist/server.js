...
const app_1 = __webpack_require__(171);
class ExpressServer {
    constructor() {
        this.onError = (error) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const bodyParser = __webpack_require__(174);
const cookieParser = __webpack_require__(179);
const express = __webpack_require__(147);
const logger = __webpack_require__(408);
const index_1 = __webpack_require__(172);
class ExpressApp {
    constructor() {
        this.getInstance = () => {
        ...
        this.initRoutes = () => {
            this.instance.use("/", index_1.default);
